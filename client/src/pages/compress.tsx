...
import { ArrowLeft, Archive, ArrowRight, PlayIcon, RotateCcw, Loader2, CheckCircle, X } from "lucide-react";
...
export default function Compress() {
  ...
  const [level, setLevel] = useState<'balanced' | 'strong'>('balanced');
  const [filename, setFilename] = useState("compressed_document.pdf");
  ...
  const handleStartNew = () => {
    ...
    setFiles([]);
    setLevel('balanced');
    setFilename("compressed_document.pdf");
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <RadioGroup 
                    value={level} 
                    onValueChange={(value: 'balanced' | 'strong') => setLevel(value)}
                    className="space-y-4"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="balanced" className="flex-1 cursor-pointer">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Good balance between file size reduction and quality preservation. Recommended for most documents.
                        </div>
                      </Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="strong" className="flex-1 cursor-pointer">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Maximum compression for smallest file size. May reduce quality but saves more space.
                        </div>
                      </Label>
                    </div>
                  </RadioGroup>
